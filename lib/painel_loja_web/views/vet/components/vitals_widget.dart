...
class _VitalsWidgetState extends State<VitalsWidget> {
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 20,
              children: [
                _buildVitalInput("Peso (kg)", _weightCtrl, FontAwesomeIcons.weightScale, width: 120),
                _buildVitalInput("Temp (°C)", _tempCtrl, FontAwesomeIcons.temperatureHalf, width: 120),
                _buildVitalInput("FC (bpm)", _hrCtrl, FontAwesomeIcons.heartPulse, width: 120),
                _buildVitalInput("FR (mpm)", _rrCtrl, FontAwesomeIcons.lungs, width: 120),
                _buildVitalInput("TPC (seg)", _crtCtrl, Icons.timer, width: 120),
              ],
            ),
            const SizedBox(height: 20),
            const Text("Mucosas", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: Colors.grey)),
            ...
            Wrap(
              ...
              children: _mucosaOptions.map((opt) {
                ...
                return ChoiceChip(
                  ...
                  avatar: CircleAvatar(backgroundColor: opt['color'], radius: 5),
  ...
  Widget _buildVitalInput(String label, TextEditingController ctrl, IconData icon, {double width = 100}) {
    return SizedBox(
      width: width,
      child: TextField(
        controller: ctrl,
