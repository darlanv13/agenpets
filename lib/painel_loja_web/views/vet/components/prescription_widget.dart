            ...
            Row(
              ...
              children: [
                ...
                TextButton.icon(
                  ...
                  label: const Text("ADICIONAR ITEM", style: TextStyle(color: Color(0xFF4A148C), fontWeight: FontWeight.bold)),
                ),
              ],
            ),
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text("Nenhum medicamento prescrito.", style: TextStyle(color: Colors.grey)),
                  ],
                ),
              )
            else
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      leading: const CircleAvatar(
                        ...
                        child: Icon(FontAwesomeIcons.pills, color: Color(0xFF4A148C), size: 16),
                      ),
                      title: Text(
                        "${med['nome']} ${med['conc']}",
        ...
        child: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Oral', 'Subcutânea', 'Intravenosa', 'Intramuscular', 'Tópica', 'Oftálmica', 'Otológica']
