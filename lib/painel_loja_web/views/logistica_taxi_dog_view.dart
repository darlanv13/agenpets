    ...
    try {
      ...
      for (var doc in hotelCheckInSnap.docs) {
        ...
        lista.add({
          ...
          'modalidade': d['modalidade_taxi'] ?? 'ida_volta',
          'status_taxi':
              d['status_taxi_ida'] ?? 'pendente', // Status específico da ida
      ...
      for (var doc in hotelCheckOutSnap.docs) {
        ...
        lista.add({
          ...
          'status_taxi':
              d['status_taxi_volta'] ??
              'pendente', // Status específico da volta
      ...
      // Ordenar por horário
      lista.sort(
        (a, b) => (a['hora'] as DateTime).compareTo(b['hora'] as DateTime),
      );
  ...
  Future<void> _abrirMapa(String endereco) async {
    ...
    if (await canLaunchUrl(Uri.parse(url))) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Não foi possível abrir o mapa.")));
    }
  }
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          backgroundColor: novoStatus == 'concluido'
              ? Colors.green
              : Colors.blue,
