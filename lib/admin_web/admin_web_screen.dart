  ...
  void _construirMenuETelas() {
    ...
    if (isRestrito) {
      ...
      _telas = [
        ...
        _buildPlaceholder("Creche (Em Breve)"), // 4
      ];
      ...
      _menuItems = [
        _MenuItem("Dashboard", Icons.space_dashboard_rounded, section: "PRINCIPAL"),
        _MenuItem("Loja / PDV", FontAwesomeIcons.cashRegister),
        _MenuItem("Agenda", Icons.calendar_month_rounded),
        _MenuItem("Hotel & Estadia", FontAwesomeIcons.hotel),
        _MenuItem("Venda de Planos", FontAwesomeIcons.cartShopping, section: "VENDAS & PRODUTOS"),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text(title, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.grey)),
