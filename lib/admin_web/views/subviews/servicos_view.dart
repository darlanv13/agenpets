          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              if (docId == null) {
                ...
                await _db.collection('servicos_extras').doc(docId).update(payload);
              }

              if (!context.mounted) return;
              Navigator.pop(ctx);
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("Serviço salvo!"), backgroundColor: Colors.green),
              );
            },
