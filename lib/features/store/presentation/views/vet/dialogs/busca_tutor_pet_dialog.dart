...
class _BuscaTutorPetDialogState extends State<BuscaTutorPetDialog> {
  ...
  Future<void> _buscarTutor() async {
    ...
    try {
      ...
      if (cliente != null) {
        final pets = await _searchService.getClientPets(
          cliente['cpf'] ?? termo,
        );
        setState(() {
  ...
  void _confirmarSelecao() {
    ...
    final petSelecionado = _petsDoTutor.firstWhere(
      (p) => p['id'] == _petIdSelecionado,
    );
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    inputFormatters: [
                      _cpfMask,
                    ], // Força formato CPF como no Hotel
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          _tutorEncontrado!['nome'] ?? 'Nome não inf.',
                          style: const TextStyle(fontWeight: FontWeight.bold),
                        ),
                        Text(
                          "CPF: ${_tutorEncontrado!['cpf']}",
                          style: TextStyle(
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          trailing: isSelected
                              ...
                              : null,
                          onTap: () =>
                              setState(() => _petIdSelecionado = p['id']),
                        ),
                      );
                    },
                  ),
