              ...
              Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Nenhuma vacina aplicada nesta consulta.",
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final revac = vac['revac_data'] != null
                      ? DateFormat(
                          'dd/MM/yyyy',
                        ).format((vac['revac_data'] as DateTime))
                      : 'Não agendada';
          ...
          children: [
            ...
            InkWell(
              ...
              child: InputDecorator(
                ...
                child: Text(
                  _revacDate != null
                      ? DateFormat('dd/MM/yyyy').format(_revacDate!)
                      : "Selecione a data",
                  style: TextStyle(
                    color: _revacDate != null ? Colors.black : Colors.grey,
                  ),
                ),
              ),
            ),
