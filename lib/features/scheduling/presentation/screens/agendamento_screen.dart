...
import 'package:agenpet/features/scheduling/data/scheduling_repository.dart';
...
class _AgendamentoScreenState extends State<AgendamentoScreen> {
  ...
  Future<void> _buscarHorarios() async {
    ...
    try {
      ...
      final grade = await _schedulingRepository.buscarHorariosDisponiveis(
        dataString,
  ...
  Future<void> _confirmarAgendamento() async {
    ...
    try {
      ...
      await _schedulingRepository.criarAgendamento(
