...
import 'package:agenpet/features/hotel/data/hotel_repository.dart';
...
class _HotelScreenState extends State<HotelScreen> {
  ...
  Future<void> _carregarDisponibilidade() async {
    final datas = await _hotelRepository.buscarDiasLotadosHotel();
    if (mounted) {
      setState(() {
        _diasLotados = datas
  ...
  Future<void> _fazerReserva() async {
    ...
    try {
      await _hotelRepository.reservarHotel(
        petId: _petId!,
        cpfUser: _userCpf!,
        checkIn: checkIn,
        checkOut: checkOut,
