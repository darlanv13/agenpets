                  ...
                  onTap: () async {
                    ...
                    await _db
                        ...
                        .update({
                          ...
                          'profissional_id':
                              pros[index].id, // Atualiza resp geral
    ...
    try {
      ...
      await showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Text("Quem fará a Tosa?", style: TextStyle(fontSize: 18)),
          content: SizedBox(
            width: double.maxFinite,
            child: ListView.builder(
              shrinkWrap: true,
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text("Erro ao selecionar tosador: $e")));
    }
  }
