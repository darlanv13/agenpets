...
class _ProntuarioPetScreenState extends State<ProntuarioPetScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [_buildHistoricoList(), _buildVacinasList()],
      ),
    );
  }
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final diagnostico =
                data['diagnostico'] as Map<String, dynamic>? ?? {};
            final queixa =
                (data['anamnese'] as Map<String, dynamic>? ?? {})['queixa'] ??
                'Consulta de Rotina';
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (diagnostico['definitivo'] != null &&
                            diagnostico['definitivo'].isNotEmpty) ...[
                        ...
                        if (data['receita'] != null &&
                            (data['receita'] as List).isNotEmpty) ...[
                          _buildSectionTitle("Prescrição"),
                          ...(data['receita'] as List)
                              .map(
                                (r) => Padding(
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final bool isVencida =
                revacData != null && revacData.isBefore(DateTime.now());
            ...
            return Card(
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    Text(
                      "Aplicada em: ${DateFormat('dd/MM/yyyy').format(aplicacaoData)}",
                    ),
                    if (revacData != null)
                      Text(
