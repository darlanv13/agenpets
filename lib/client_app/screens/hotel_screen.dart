...
class _HotelScreenState extends State<HotelScreen> {
  ...
  Future<void> _carregarPrecoHotel() async {
    try {
      ...
      if (doc.exists) {
        setState(() {
          _valorDiaria = (doc.data()!['preco_hotel_diaria'] ?? 80.00).toDouble();
        });
      }
    } catch (e) {
                  ...
                  Container(
                    ...
                    child: TableCalendar(
                      ...
                      calendarStyle: CalendarStyle(
                        ...
                        disabledTextStyle: GoogleFonts.poppins(color: Colors.red[200]),
                      ),
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      _buildSummaryRow(FontAwesomeIcons.paw, "Pet", _petNome ?? ""),
                      SizedBox(height: 20),
                        ...
                        children: [
                          Expanded(
                            child: _buildSummaryBox(
                              ...
                              "Check-in",
                              _rangeStart != null ? DateFormat('dd/MM').format(_rangeStart!) : "-",
                            ),
                          ),
                          SizedBox(width: 15),
                          Expanded(
                            child: _buildSummaryBox(
                              ...
                              "Check-out",
                              _rangeEnd != null ? DateFormat('dd/MM').format(_rangeEnd!) : (_rangeStart != null ? DateFormat('dd/MM').format(_rangeStart!) : "-"),
                            ),
                          ),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          Text("Diárias ($dias)", style: GoogleFonts.poppins(color: Colors.grey[600])),
                          Text("R\$ ${total.toStringAsFixed(2)}", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18, color: _corAcai)),
                        ],
                      )
                    ],
                  ),
