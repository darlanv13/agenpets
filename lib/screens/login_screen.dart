...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _verificarAcesso() async {
    ...
    try {
      // PROJETO SEPARADO: A área do profissional será movida para um App à parte.
      // Removemos a verificação de profissional aqui para evitar bifurcação no App do Cliente.
      // O fluxo agora segue sempre como Cliente.
