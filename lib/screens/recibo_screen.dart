...
class ReciboScreen extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                Icon(FontAwesomeIcons.clipboardCheck, color: _corAcai, size: 18),
                SizedBox(width: 10),
                Text(
                  "Checklist de Saúde",
                  style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                Wrap(
                  ...
                  runSpacing: 10,
                  children: [
                    _buildCheckChip("Nós: ${_capitalize(nivelNos)}",
  ...
  Future<void> _generatePdf(BuildContext context) async {
    ...
    final Timestamp? ts = data['data_inicio'];
    final DateTime dataInicio = ts != null ? ts.toDate() : DateTime.now();
    final double valorPago = (data['valor_final_cobrado'] ??
            (data['valor'] ?? 0))
        .toDouble();
    final String servico = _capitalize(data['servico'] ?? 'Serviço');
    final String profissional = data['profissional_nome'] ?? 'Não informado';
            ...
            children: [
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Wrap(
                        ...
                        runSpacing: 10,
                        children: [
                          _buildPdfChip("Nós: ${_capitalize(checklist['nivel_nos'] ?? 'nenhum')}"),
                          _buildPdfChip("Pulgas: ${checklist['tem_pulgas'] == true ? 'Sim' : 'Não'}", isAlert: checklist['tem_pulgas'] == true),
                          _buildPdfChip("Lesões: ${checklist['tem_lesoes'] == true ? 'Sim' : 'Não'}", isAlert: checklist['tem_lesoes'] == true),
                          _buildPdfChip("Otite: ${checklist['tem_otite'] == true ? 'Sim' : 'Não'}", isAlert: checklist['tem_otite'] == true),
                          _buildPdfChip("Agressivo: ${checklist['agressivo'] == true ? 'Sim' : 'Não'}", isAlert: checklist['agressivo'] == true),
                        ],
                      ),
              ...
              if (fotosWidgets.isNotEmpty) ...[
                ...
                pw.Wrap(
                  spacing: 10,
                  runSpacing: 10,
                  children: fotosWidgets,
                ),
              ],

              pw.Spacer(),
              pw.Center(child: pw.Text("Obrigado pela preferência!", style: pw.TextStyle(fontStyle: pw.FontStyle.italic, color: PdfColors.grey))),
            ],
          );
        },
      ),
